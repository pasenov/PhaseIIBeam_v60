...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
 ...
 if (((volume == fDetectorconstruction->GetWorld()) || (volume == fDetectorconstruction->GetBPIX12())) && (volume != fDetectorconstruction->GetDet1()) && (volume != fDetectorconstruction->GetDet2()) && (volume != fDetectorconstruction->GetBPIX34()) && (volume != fDetectorconstruction->GetScint1()) && (volume != fDetectorconstruction->GetScint2()) && (volume != fDetectorconstruction->GetAl())){
   fEventaction->AddEnergyDepositAir(edep);
 }
