...
void EventAction::BeginOfEventAction(const G4Event* evt)
{
 ...
 fEnergyDeposit1  =  fEnergyDeposit2 = fEnergyDepositSc1 = fEnergyDepositSc2 = fEnergyDepositAir = fEnergyDepositAl = fEnergySecondary1 = fEnergySecondary2 = fEnergyTertiary1 = fEnergyTertiary2 = 0.;
